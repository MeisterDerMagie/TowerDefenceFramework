...
public class MartinOverpoweredStrategy : AbstractStrategy
{
    private StateMachine _defense;
    private StateMachine _offense;
    
    public MartinOverpoweredStrategy(Player player) : base(player)
    {
        BuildDefense();
        BuildOffense();
    }
    ...
    private void BuildDefense()
    {
        ...
        var initialState = new OverpoweredState(player, _defense, "");
    ...
    private void BuildOffense()
    {
        ...
        var initialState = new OverpoweredState(player, _offense, "");
